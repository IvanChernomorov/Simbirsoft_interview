...
Ранее в примерах ([тут](#no-getters-and-setters-1), [тут](#no-getters-and-setters-2) и [тут](#no-getters-and-setters-3)) я не добавлял геттеры и сеттеры для большей лаконичности кода, но вообще их принято создавать *всегда*.
